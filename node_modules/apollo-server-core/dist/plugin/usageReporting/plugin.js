...
const defaultUsageReportingSignature_1 = require("./defaultUsageReportingSignature");
...
const referencedFields_1 = require("./referencedFields");
                    ...
                    async willSendResponse(requestContext) {
                        ...
                        if (includeOperationInUsageReporting === false) {
                            if (resolvedOperation)
                                reportData.report.operationCount++;
                            return;
                        }
                        ...
                        function getOperationDerivedData() {
                            ...
                            const generatedSignature = (options.calculateSignature || defaultUsageReportingSignature_1.defaultUsageReportingSignature)(requestContext.document, requestContext.operationName || '');
                            const generatedOperationDerivedData = {
                                signature: generatedSignature,
                                referencedFieldsByType: (0, referencedFields_1.calculateReferencedFieldsByType)({
