...
export declare class GraphQLSchemaBuilder {
    ...
    build(autoSchemaFile: string | boolean, options: GqlModuleOptions, resolvers: Function[]): Promise<any>;
    generateSchema(resolvers: Function[], autoSchemaFile: boolean | string, options?: BuildSchemaOptions, sortSchema?: boolean, transformSchema?: (schema: GraphQLSchema) => GraphQLSchema | Promise<GraphQLSchema>): Promise<GraphQLSchema>;
}
