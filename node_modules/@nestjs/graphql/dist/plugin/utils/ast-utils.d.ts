import { Decorator, Node, ObjectFlags, Type, TypeChecker, TypeFlags, TypeFormatFlags, SourceFile, UnionTypeNode, TypeNode } from 'typescript';
...
export declare function getDescriptionOfNode(node: Node, sourceFile: SourceFile): string;
