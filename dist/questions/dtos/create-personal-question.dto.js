...
exports.CreatePersonalQuestionOutput = exports.CreatePersonalQuestionInput = void 0;
const graphql_1 = require("@nestjs/graphql");
const personal_question_schema_1 = require("../schemas/personal-question.schema");
const output_dto_1 = require("../../common/dtos/output.dto");
let CreatePersonalQuestionInput = class CreatePersonalQuestionInput extends (0, graphql_1.PickType)(personal_question_schema_1.PersonalQuestion, [
    'content',
    'description',
    'required',
    'order',
