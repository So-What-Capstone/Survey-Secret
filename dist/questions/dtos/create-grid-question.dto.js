...
exports.CreateGridQuestionOutput = exports.CreateGridQuestionInput = void 0;
const graphql_1 = require("@nestjs/graphql");
const output_dto_1 = require("./../../common/dtos/output.dto");
const grid_question_scheam_1 = require("./../schemas/grid-question.scheam");
let CreateGridQuestionInput = class CreateGridQuestionInput extends (0, graphql_1.PickType)(grid_question_scheam_1.GridQuestion, [
    'content',
    'rowContent',
    'colContent',
    'description',
