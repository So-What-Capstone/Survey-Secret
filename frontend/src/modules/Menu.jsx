            ...
            <div className='container-sub'> 
                ...
                <div className='menu-lists'>
                    <div className='menu-list'>
                        <a className="list-item" href="#none">내 설문</a>
                        <a className="list-item" href="#none">새 설문 만들기</a>
                    </div>
                    <div className='menu-list'>
                        <a className="list-item" href="#none">문자 서비스</a>
                        <a className="list-item" href="#none">이메일 서비스</a>
                        <a className="list-item" href="#none">서비스 이용기록</a>
                    </div>
                    <div className='menu-list'>
                        <a className="list-item" href="#none">공지사항</a>
                        <a className="list-item" href="#none">이용방법</a> 
                    </div>
                </div>
